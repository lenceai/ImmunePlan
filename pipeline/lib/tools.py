...
DRUG_INTERACTIONS = {
    # --- Conventional DMARDs ---
    "methotrexate": {
        "class": "Conventional DMARD",
        "common_interactions": ["NSAIDs (increased toxicity)", "trimethoprim (bone marrow suppression)",
                                "alcohol (hepatotoxicity)", "probenecid (increased MTX levels)"],
        "monitoring": ["CBC every 4-8 weeks", "LFTs every 4-8 weeks", "renal function", "folate supplementation"],
        "contraindications": ["pregnancy", "severe hepatic impairment", "immunodeficiency", "significant renal impairment"],
    },
    "hydroxychloroquine": {
        "class": "Antimalarial DMARD",
        "common_interactions": ["antacids (reduced absorption)", "digoxin (increased levels)", "QT-prolonging drugs"],
        "monitoring": ["ophthalmology exam every year after 5 years", "ECG if cardiac history"],
        "contraindications": ["known retinal disease", "G6PD deficiency (relative)"],
    },
    "sulfasalazine": {
        "class": "Conventional DMARD",
        "common_interactions": ["folic acid antagonists", "warfarin (increased effect)", "digoxin (reduced absorption)"],
        "monitoring": ["CBC and LFTs every 2-4 weeks for first 3 months, then quarterly"],
        "contraindications": ["sulfa allergy", "salicylate allergy", "porphyria", "severe hepatic/renal impairment"],
    },
    "leflunomide": {
        "class": "Conventional DMARD",
        "common_interactions": ["methotrexate (hepatotoxicity)", "rifampicin (increased leflunomide levels)", "cholestyramine (washout)"],
        "monitoring": ["CBC and LFTs monthly for 6 months then every 6-8 weeks", "blood pressure"],
        "contraindications": ["pregnancy", "severe immunodeficiency", "hepatic impairment", "bone marrow suppression"],
    },
    "azathioprine": {
        "class": "Immunosuppressant",
        "common_interactions": ["allopurinol (CRITICAL — dramatically increases toxicity)", "warfarin", "live vaccines"],
        "monitoring": ["CBC weekly for first month, then monthly", "LFTs", "TPMT testing before start"],
        "contraindications": ["TPMT deficiency", "active infection", "hypersensitivity"],
    },
    # --- Anti-TNF Biologics ---
    "adalimumab": {
        "class": "Anti-TNF biologic (monoclonal antibody)",
        "common_interactions": ["live vaccines (contraindicated)", "other biologics (increased infection risk)", "anakinra"],
        "monitoring": ["TB screening before start", "hepatitis B screening", "CBC periodically", "skin checks"],
        "contraindications": ["active infection", "TB", "heart failure NYHA III-IV", "demyelinating disease"],
    },
    "infliximab": {
        "class": "Anti-TNF biologic (chimeric monoclonal antibody)",
        "common_interactions": ["live vaccines (contraindicated)", "other biologics", "immunosuppressants (ADA risk)"],
        "monitoring": ["infusion reactions", "TB screening", "hepatitis B", "CBC", "ADA levels"],
        "contraindications": ["active infection", "TB", "moderate-severe heart failure", "demyelinating disease"],
    },
    "etanercept": {
        "class": "Anti-TNF biologic (fusion protein)",
        "common_interactions": ["live vaccines (contraindicated)", "other biologics", "cyclophosphamide (increased malignancy risk)"],
        "monitoring": ["TB screening", "CBC", "injection site reactions"],
        "contraindications": ["active infection", "TB", "heart failure", "demyelinating disease"],
    },
    "certolizumab": {
        "class": "Anti-TNF biologic (PEGylated Fab fragment)",
        "common_interactions": ["live vaccines (contraindicated)", "other biologics"],
        "monitoring": ["TB screening", "hepatitis B", "CBC"],
        "contraindications": ["active infection", "TB"],
        "notes": "Only anti-TNF without Fc region — low placental transfer, may be used in pregnancy after risk/benefit discussion",
    },
    "golimumab": {
        "class": "Anti-TNF biologic (human monoclonal antibody)",
        "common_interactions": ["live vaccines (contraindicated)", "other biologics", "CYP450 substrates"],
        "monitoring": ["TB screening", "hepatitis B", "CBC", "LFTs"],
        "contraindications": ["active infection", "TB", "heart failure NYHA III-IV"],
    },
    # --- JAK Inhibitors ---
    "tofacitinib": {
        "class": "JAK inhibitor (JAK1/JAK3)",
        "common_interactions": ["strong CYP3A4 inhibitors (ketoconazole — increase levels)", "rifampicin (reduces levels)",
                                "live vaccines", "other immunosuppressants"],
        "monitoring": ["CBC at baseline and after 4-8 weeks", "lipids at 4-8 weeks", "LFTs", "creatinine",
                       "VTE risk assessment (boxed warning)"],
        "contraindications": ["active infection", "ALC <500/mm³", "ANC <1000/mm³", "Hgb <8 g/dL"],
        "notes": "Boxed warning: serious infections, malignancy, MACE, thrombosis",
    },
    "upadacitinib": {
        "class": "JAK inhibitor (selective JAK1)",
        "common_interactions": ["strong CYP3A4 inhibitors", "live vaccines", "other immunosuppressants"],
        "monitoring": ["CBC, lipids, LFTs at baseline and periodically", "VTE risk", "skin malignancy"],
        "contraindications": ["active serious infection", "pregnancy", "ALC <500/mm³"],
        "notes": "Boxed warning: serious infections, malignancy, MACE, thrombosis",
    },
    "baricitinib": {
        "class": "JAK inhibitor (JAK1/JAK2)",
        "common_interactions": ["probenecid (increases baricitinib exposure)", "OAT3 inhibitors", "live vaccines"],
        "monitoring": ["CBC, lipids, creatinine at baseline and periodically", "VTE risk"],
        "contraindications": ["eGFR <15 mL/min", "active serious infection"],
        "notes": "Also approved for COVID-19 and atopic dermatitis",
    },
    # --- Other Biologics ---
    "rituximab": {
        "class": "Anti-CD20 biologic (B-cell depleting)",
        "common_interactions": ["live vaccines (avoid for 12+ months)", "other immunosuppressants",
                                "nephrotoxic drugs (with cisplatin)"],
        "monitoring": ["CBC before each infusion", "immunoglobulin levels", "hepatitis B screening (reactivation risk)",
                       "PML screening", "infusion reactions"],
        "contraindications": ["active severe infection", "hepatitis B (active)", "severe heart failure"],
        "notes": "Used in RA after anti-TNF failure, ANCA vasculitis, pemphigus",
    },
    "tocilizumab": {
        "class": "Anti-IL-6 receptor biologic",
        "common_interactions": ["live vaccines", "CYP450 substrates (normalized as IL-6 is inhibited)",
                                "other biologics"],
        "monitoring": ["neutrophils, platelets, LFTs before each infusion", "lipids"],
        "contraindications": ["active infection", "ANC <2000/mm³", "platelets <100,000/mm³", "ALT/AST >1.5× ULN"],
        "notes": "Monitor for GI perforation, especially with diverticulosis",
    },
    "abatacept": {
        "class": "T-cell co-stimulation modulator (CTLA4-Ig)",
        "common_interactions": ["live vaccines (contraindicated)", "other biologics (especially anti-TNF)",
                                "anakinra"],
        "monitoring": ["TB screening", "hepatitis B", "CBC"],
        "contraindications": ["active infection", "COPD (increased respiratory events relative risk)"],
    },
    "vedolizumab": {
        "class": "Anti-integrin biologic (gut-selective)",
        "common_interactions": ["live vaccines (contraindicated)", "natalizumab (not recommended)",
                                "TNF antagonists"],
        "monitoring": ["TB screening at baseline", "infusion reactions"],
        "contraindications": ["active serious infection", "hypersensitivity"],
        "notes": "Gut-selective; lower systemic immunosuppression than anti-TNFs",
    },
    "ustekinumab": {
        "class": "Anti-IL-12/23 biologic",
        "common_interactions": ["live vaccines (contraindicated)", "other biologics"],
        "monitoring": ["TB screening", "skin malignancy surveillance"],
        "contraindications": ["active TB or serious infection"],
        "notes": "Single IV induction dose; SC maintenance. Used in Crohn's, PsA, plaque psoriasis",
    },
    "risankizumab": {
        "class": "Anti-IL-23 biologic (p19 subunit)",
        "common_interactions": ["live vaccines (contraindicated)"],
        "monitoring": ["TB screening", "skin malignancy"],
        "contraindications": ["active serious infection"],
        "notes": "Selective IL-23 blockade; approved for Crohn's, PsA, plaque psoriasis",
    },
    "secukinumab": {
        "class": "Anti-IL-17A biologic",
        "common_interactions": ["live vaccines (contraindicated)", "CYP450 substrates"],
        "monitoring": ["TB screening", "Candida infections", "IBD symptom monitoring"],
        "contraindications": ["active serious infection", "Crohn's disease (risk of worsening)"],
    },
    # --- SLE-specific ---
    "belimumab": {
        "class": "Anti-BLyS/BAFF biologic",
        "common_interactions": ["live vaccines (avoid)", "cyclophosphamide (not studied together)"],
        "monitoring": ["psychiatric symptoms (depression, suicidality)", "infection signs", "CBC"],
        "contraindications": ["active CNS lupus (relative)", "active severe infection"],
        "notes": "Approved specifically for SLE and lupus nephritis",
    },
}
